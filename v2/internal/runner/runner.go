...
import (
	...
	"github.com/gcmurphy/nuclei/v2/internal/colorizer"
	...
	"github.com/gcmurphy/nuclei/v2/pkg/core/inputs/hybrid"
	"github.com/gcmurphy/nuclei/v2/pkg/output"
	"github.com/gcmurphy/nuclei/v2/pkg/parsers"
	"github.com/gcmurphy/nuclei/v2/pkg/progress"
	"github.com/gcmurphy/nuclei/v2/pkg/projectfile"
	"github.com/gcmurphy/nuclei/v2/pkg/protocols"
	"github.com/gcmurphy/nuclei/v2/pkg/protocols/common/automaticscan"
	"github.com/gcmurphy/nuclei/v2/pkg/protocols/common/hosterrorscache"
	...
	"github.com/gcmurphy/nuclei/v2/pkg/protocols/http/httpclientpool"
	"github.com/gcmurphy/nuclei/v2/pkg/reporting"
	"github.com/gcmurphy/nuclei/v2/pkg/reporting/exporters/markdown"
	"github.com/gcmurphy/nuclei/v2/pkg/reporting/exporters/sarif"
	...
	yamlwrapper "github.com/gcmurphy/nuclei/v2/pkg/utils/yaml"
...
func (r *Runner) readNewTemplatesWithVersionFile(version string) ([]string, error) {
	resp, err := http.DefaultClient.Get(fmt.Sprintf("https://raw.githubusercontent.com/gcmurphy/nuclei-templates/%s/.new-additions", version))
	if err != nil {
		return nil, err
	}
