...
type Action struct {
	...
	//   which can be matched upon by nuclei. An Example template [here](https://github.com/gcmurphy/nuclei-templates/blob/master/headless/prototype-pollution-check.yaml).
